...
{
    fwrite(STDERR, "time: " . date(\PHPDocTool\App::DATE_TIME_FORMAT) . " ");
...
function cliHandleRedisConnectionException(
    Application $console,
    \PHPDocTool\Exception\RedisConnectionException $rce
) {
    echo "Could not connect to redis. Check the redis container is running.\n";
    exit(-1);
}
